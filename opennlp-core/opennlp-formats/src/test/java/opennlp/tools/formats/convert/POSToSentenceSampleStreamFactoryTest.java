...
public class POSToSentenceSampleStreamFactoryTest extends
        AbstractSampleStreamFactoryTest<SentenceSample, POSToSentenceSampleStreamFactory.Parameters> {
  ...
  // SUT
  private POSToSentenceSampleStreamFactory factory;

  private String detokFileFullPath;
  private String sampleFileFullPath;

  @Override
  protected AbstractSampleStreamFactory<SentenceSample, POSToSentenceSampleStreamFactory.Parameters>
      getFactory() {
    return factory;
  }
  ...
  @BeforeEach
  void setUp() {
    ObjectStreamFactory<SentenceSample, POSToSentenceSampleStreamFactory.Parameters> f =
            StreamFactoryRegistry.getFactory(SentenceSample.class, "pos");
    assertInstanceOf(POSToSentenceSampleStreamFactory.class, f);
    factory = (POSToSentenceSampleStreamFactory) f;
    assertEquals(POSToSentenceSampleStreamFactory.Parameters.class, factory.getParameters());
