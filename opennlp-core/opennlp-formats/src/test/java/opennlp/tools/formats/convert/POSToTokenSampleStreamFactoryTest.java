...
public class POSToTokenSampleStreamFactoryTest extends
        AbstractSampleStreamFactoryTest<TokenSample, POSToTokenSampleStreamFactory.Parameters> {
  ...
  // SUT
  private POSToTokenSampleStreamFactory factory;

  private String detokFileFullPath;
  private String sampleFileFullPath;

  @Override
  protected AbstractSampleStreamFactory<TokenSample, POSToTokenSampleStreamFactory.Parameters>
      getFactory() {
    return factory;
  }
  ...
  @BeforeEach
  void setUp() {
    ObjectStreamFactory<TokenSample, POSToTokenSampleStreamFactory.Parameters> f =
            StreamFactoryRegistry.getFactory(TokenSample.class, "pos");
    assertInstanceOf(POSToTokenSampleStreamFactory.class, f);
    factory = (POSToTokenSampleStreamFactory) f;
    assertEquals(POSToTokenSampleStreamFactory.Parameters.class, factory.getParameters());
