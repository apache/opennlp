...
public class ScaleDoesntMatterTest {
  ...
  void testScaleResults() throws Exception {
    ...
    EventTrainer<TrainingParameters> smallModelTrainer = TrainerFactory.getEventTrainer(
    ...
    EventTrainer<TrainingParameters> largeModelTrainer = TrainerFactory.getEventTrainer(
        ModelUtil.createDefaultTrainingParameters(), null);
