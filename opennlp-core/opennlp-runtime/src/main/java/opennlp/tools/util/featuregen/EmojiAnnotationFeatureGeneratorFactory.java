...
/**
 * A {@link GeneratorFactory} that produces {@link EmojiAnnotationFeatureGenerator} instances
 * when {@link #create()} is called, for use in a feature generation descriptor:
 *
 * <pre>{@code
