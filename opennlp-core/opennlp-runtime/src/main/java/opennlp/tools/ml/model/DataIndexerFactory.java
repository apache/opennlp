...
public class DataIndexerFactory {
   ...
   * @see ExtensionLoader
   */
  public static <P extends Parameters> DataIndexer<P> getDataIndexer(
          P parameters, Map<String, String> reportMap) {
    ...
    DataIndexer<P> indexer = (DataIndexer<P>) switch (indexerParam) {
