...
public class NameFinderInference extends Inference {

  public NameFinderInference(File model, File vocab, InferenceOptions inferenceOptions) throws Exception {
    super(model, vocab, inferenceOptions);
  }

  @Override
  public Object infer(final String text) throws Exception {
