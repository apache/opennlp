 ...
 * {@link opennlp.spellcheck.SpellChecker} using a precomputed deletes-only index for
 * single-term lookup and compound (split/merge) correction;
 * {@link opennlp.spellcheck.symspell.SymSpellConfig} holds its immutable, builder-created
 * configuration. The engine is an independent Java re-implementation of the algorithm by
