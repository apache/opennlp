 ...
 */
public class NameFinderME2 implements TokenNameFinder {
  ...
  public NameFinderME2(TokenNameFinderModel model) {
    this(model, 3);
  }
   ...
   * @param beamSize
   */
  public NameFinderME2(TokenNameFinderModel model, int beamSize) {
   ...
   */
  @Deprecated
  public NameFinderME2(MaxentModel mod) {
   ...
   */
  @Deprecated
  public NameFinderME2(MaxentModel mod, NameContextGenerator cg) {
    this(mod, cg, 3);
  }
   ...
   */
  @Deprecated
  public NameFinderME2(MaxentModel mod, NameContextGenerator cg, int beamSize) {
    model = mod;
    contextGenerator = cg;
  ...
  public Span[] find(String[] tokens, String[][] additionalContext) {
    ...
    for (int li = 0; li < c.size(); li++) {
      ...
      if (chunkTag.equals(NameFinderME2.START)) {
        if (start != -1) {
      ...
      else if (chunkTag.equals(NameFinderME2.CONTINUE)) {
        end = li + 1;
      }
      else if (chunkTag.equals(NameFinderME2.OTHER)) {
        if (start != -1) {
          spans.add(new Span(start, end));
          start = -1;
          end = -1;
  ...
  /**
   ...
   public static TokenNameFinderModel train(String languageCode, Iterator<NameSample> samples, InputStream descriptorIn, Resource resource,Map<String, Object> resources) throws IOException, InvalidFormatException {
     ...
     return new TokenNameFinderModel(languageCode, nameFinderModel, descriptorIn, resources);
   }
  ...
  public static void main(String[] args) throws IOException, InvalidFormatException {
    ...
    if (args.length == 5) {
      ...
      InputStream descriptor = new FileInputStream(file);
      
      TokenNameFinderModel model = 
          NameFinderME2.train("x-unspecified",sampleStream, descriptor, new FileSystemResource(file), new HashMap<String, Object>());
