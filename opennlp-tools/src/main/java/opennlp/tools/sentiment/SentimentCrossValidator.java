...
public class SentimentCrossValidator {
  ...
  private static class SentimentToDocumentSampleStream
     ...
     * Constructor
     */
    protected SentimentToDocumentSampleStream(ObjectStream<SentimentSample> samples) {
      super(samples);
    }
  ...
  private static class DocumentToSentimentSampleStream
    ...
    private Iterator<SentimentSample> documentSamples = Collections.emptyIterator();
