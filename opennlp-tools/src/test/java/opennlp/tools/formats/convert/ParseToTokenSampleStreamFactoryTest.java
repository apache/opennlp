...
public class ParseToTokenSampleStreamFactoryTest extends
        AbstractSampleStreamFactoryTest<TokenSample, ParseToTokenSampleStreamFactory.Parameters> {
  ...
  // SUT
  private ParseToTokenSampleStreamFactory factory;

  private String detokFileFullPath;
  private String sampleFileFullPath;

  @Override
  protected AbstractSampleStreamFactory<TokenSample, ParseToTokenSampleStreamFactory.Parameters>
      getFactory() {
    return factory;
  }
  ...
  @BeforeEach
  void setUp() {
    ObjectStreamFactory<TokenSample, ParseToTokenSampleStreamFactory.Parameters> f =
            StreamFactoryRegistry.getFactory(TokenSample.class, "parse");
    assertInstanceOf(ParseToTokenSampleStreamFactory.class, f);
    factory = (ParseToTokenSampleStreamFactory) f;
    assertEquals(ParseToTokenSampleStreamFactory.Parameters.class, factory.getParameters());
