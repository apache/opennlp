...
public class NameToSentenceSampleStreamFactoryTest extends
        AbstractSampleStreamFactoryTest<SentenceSample, NameToSentenceSampleStreamFactory.Parameters> {
  ...
  // SUT
  private NameToSentenceSampleStreamFactory factory;

  private String detokFileFullPath;
  private String sampleFileFullPath;

  @Override
  protected AbstractSampleStreamFactory<SentenceSample, NameToSentenceSampleStreamFactory.Parameters>
      getFactory() {
    return factory;
  }
  ...
  @BeforeEach
  void setUp() {
    ObjectStreamFactory<SentenceSample, NameToSentenceSampleStreamFactory.Parameters> f =
            StreamFactoryRegistry.getFactory(SentenceSample.class, "namefinder");
    assertInstanceOf(NameToSentenceSampleStreamFactory.class, f);
    factory = (NameToSentenceSampleStreamFactory) f;
    assertEquals(NameToSentenceSampleStreamFactory.Parameters.class, factory.getParameters());
